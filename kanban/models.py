...
class Users(models.Model):
    ...
    u_team = models.ForeignKey(Teams, on_delete=models.CASCADE)
...
class Boards(models.Model):
    ...
    b_team = models.ForeignKey(Teams, on_delete=models.CASCADE)


class Lists(models.Model):
    list_name = models.CharField(max_length=30)
    list_position = models.IntegerField()
    list_board = models.ForeignKey(Boards, on_delete=models.CASCADE)
...
class Cards(models.Model):
    ...
    c_assigned = models.ForeignKey(Users, on_delete=models.CASCADE)
    c_deadline = models.DateTimeField('deadline')
    c_complexity = models.IntegerField(default=1)
    c_list = models.ForeignKey(Lists, on_delete=models.CASCADE)

class Categories(models.Model):
    cat_name = models.CharField(max_length=20)
    cat_board = models.ForeignKey(Boards, on_delete=models.CASCADE)